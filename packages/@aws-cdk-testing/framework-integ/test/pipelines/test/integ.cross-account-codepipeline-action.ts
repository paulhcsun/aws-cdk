...
export class CodePipelineAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: CodePipelineAppStackProps) {
    ...
    const bucketName = `test-bucket-xaccnt-${cdk.Names.uniqueId(this).toLowerCase()}`;
    // Artifact buckets
...
export class TargetAccountRoleStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const crossAccountRole = new iam.Role(this, 'my26marCrossAccountDeploymentRole', {
      roleName: 'my26marCrossAccountDeploymentRole',
    ...
    new cdk.CfnOutput(this, 'my26marCrossAccountDeploymentRoleArn', {
      value: crossAccountRole.roleArn,
      exportName: 'my26marCrossAccountDeploymentRoleArn',
    });
  }
}
...
const targetStack = new TargetAccountRoleStack(app, 'my26marDeployActionStack', {
  env: { account: '813021164746', region: 'us-east-1' },
});

const sourceStack = new CodePipelineAppStack(app, 'my26marCodePipelineActionAppStack', {
...
new integ.IntegTest(app, 'CdkCodePipelineActionTest', {
